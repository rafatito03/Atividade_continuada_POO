...
public class SeguradoMediator {
	...
	public String validarNome(String nome) {
		if (StringUtils.ehNuloOuBranco(nome)) return "Nome não pode ser vazio.";
	...
	public String validarEndereco(Endereco endereco) {
		if (endereco == null) return "Endereço é obrigatório.";
	...
	public String validarDataCriacao(LocalDate dataCriacao) {
		if(dataCriacao == null) return "Data de criação inválida.";
		return null;
	}
