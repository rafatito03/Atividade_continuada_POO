...
public class TesteSinistroDAO extends TesteDAO {
	...
	private Sinistro sinistroTeste = new Sinistro(null, veiculoTeste, LocalDateTime.now(), LocalDateTime.now(), "fil", new BigDecimal(11111), TipoSinistro.getTipoSinistro(1));
	...
	public void teste08() {
		cadastro.incluir(sinistroTeste, sinistroTeste.getNumero());
		Sinistro si = new Sinistro(null, veiculoTeste, LocalDateTime.now(), LocalDateTime.now(), "fil", new BigDecimal(22222), TipoSinistro.getTipoSinistro(1));
